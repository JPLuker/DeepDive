...
## 47. Duplicate-only library scrub (2.9.102)
...
- [ ] Privacy copy clearly says DeepDive cannot collect user data and
      explains that there is no server, database or account system
